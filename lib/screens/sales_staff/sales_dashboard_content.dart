...
class _ModernSalesDashboardState extends State<ModernSalesDashboard>
  ...
  Future<void> _loadDashboardStatistics() async {
    ...
    try {
      ...
      _totalSales = salesSnapshot.size;
      ...
      _totalCustomers = customersSnapshot.size;

      // Load pending tasks
      final pendingTasksSnapshot = await FirebaseFirestore.instance
          .collection('todoTasks')
          .where('assignedTo', isEqualTo: 'sales')
          .where('status', isEqualTo: 'Pending')
          .get();
      _pendingTasks = pendingTasksSnapshot.size;
    } catch (e) {
                        ...
                        child: ListView(
                          ...
                          children: [
                            ...
                            _buildMenuItem('Dashboard', Icons.dashboard, 0,
                                _selectedIndex == 0),
                            _buildMenuItem('Performance', Icons.analytics, 1,
                                _selectedIndex == 1),
                            _buildMenuHeader('Sales', _isSidebarExpanded),
                            _buildMenuItem(
                                'Enquiries', Icons.question_answer, 2, false),
                            _buildMenuItem('Customers', Icons.people, 3, false),
                            _buildMenuItem(
                                'Products', Icons.inventory, 4, false),
                          ],
                        ),
                      ),
                      const Divider(
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    // Announcement card
                    const ModernAnnouncementCard(role: 'sales'),
                      ...
                      child: RefreshIndicator(
                        ...
                        child: TabBarView(
                          ...
                          children: [
                            ...
                            // Performance tab
                            buildPerformanceTab(size, isMobile),
                          ],
                        ),
                      ),
                    ),
  ...
  Widget buildPerformanceTab(Size size, bool isMobile) {
  ...
  Widget _buildPerformanceChart() {
    ...
    return Container(
      ...
      child: const Center(
        child: Text('Sales Chart - Replace with actual chart implementation'),
      ),
    );
  }
...
// Original SalesDashboardContent class remains for backward compatibility
...
class _SalesDashboardContentState extends State<SalesDashboardContent> {
  ...
  Widget build(BuildContext context) {
    ...
    return const ModernSalesDashboard();
  }
}
